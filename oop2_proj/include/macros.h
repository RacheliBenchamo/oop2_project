...
{
	MENU_BACKGROUND, FOREST_BACKGROUND, SNOW_BACKGROUND, DESERT_BACKGROUND,
	HELP_BACKGROUND, LOSE_LEVEL_BACKGROUND, WIN_GAME_BACKGROUND
};

enum sounds
{
	S_MENU,S_IN_TELEPORT, S_LOSE_LEVEL, S_WIN_LEVEL, S_WIN_GAME, S_BACKROUND,
	S_TAKE_DIAMOND, S_TAKE_POSION, S_ABOVE, S_CLICKED, S_FIGHT,S_REACHED_ALL_DIAMONDS,
	S_NO_PLAYER_SELECTED
};
...
enum levels{ FOREST, SNOW,DESERT };
...
P_RESTART_ICON(11, 9, 97, 96),
P_STOP_ICON(228, 232, 100, 94),
P_PLAY_ICON(119, 8, 98, 96),
P_MUSIC_ON(119, 446, 100, 98),
P_MUSIC_OFF(230, 446, 100, 98),
P_SOUND_ON(340, 120, 100, 98),
P_SOUND_OFF(340, 230, 100, 98);
