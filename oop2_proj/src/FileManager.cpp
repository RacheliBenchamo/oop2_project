...
void FileManager::createPlayerAnimeData()
{
	...
	({ 103, 108 }, { 490, 128 }, 25, 2, Walk), 0.009f, false);
...
void FileManager::createForestMonstersAnimeData()
{
	...
	({ 60, 55 }, { 3, 60 }, 5, 4, Walk), 0.02f, false);
	...
	({ 82, 82 }, { 1, 90 }, 5, 4, Walk), 0.02f, false);
	...
	({ 97, 60 }, { 1, 80 }, 3, 4, Walk), 0.02f, false);
...
void FileManager::createSnowMonstersAnimeData()
{
	...
	({ 37, 35 }, { 1, 53 }, 10, 6, Walk), 0.02f, false);
...
void FileManager::createDesertMonstersAnimeData()
{
	...
	({ 49, 90 }, { 1, 92 }, 15, 4, Walk), 0.02f, false);
	...
	({ 55, 42 }, { 6, 67 }, 3,12, Walk), 0.02f, false);
